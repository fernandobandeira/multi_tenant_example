defmodule Backend.Tenants do
  ...
  ## Examples
      ...
      iex> get_tenant!(foo.localhost)
      %Tenant{}

      iex> get_tenant!(bar.localhost)
      ** (Ecto.NoResultsError)

  """
  def get_tenant!(domain), do: Repo.get_by!(Tenant, domain: domain)
